      ...
      <div class="navbar-fixed">
         <nav id="nav" >
            <div class="nav-wrapper">
               <a href="<?= BASE_URL ?>" class="brand-logo flow-text white-text lighten-5" style="margin-left:10px ">Nepalese Student Association</a>
               ...
               <ul class="right hide-on-med-and-down ">
                  ...
                  <li><a class="white-text lighten-5 " href="<?= BASE_URL ?>/executive">Executive Board</a></li>
               ...
               <ul class="side-nav" id="mobile" >
                  ...
                  <li><a class="waves-red" href="<?= BASE_URL ?>/about">About Us</a></li>
                  <li><a class="waves-red" href="<?= BASE_URL ?>/executive">Executive Board</a></li>
                  <li><a class="waves-red" href="<?= BASE_URL ?>/events">Events</a></li>
                  <li><a class="waves-red" href="<?= BASE_URL ?>/gallery">Gallery</a></li>
                  <li><a class="waves-red" href="<?= BASE_URL ?>/members">Members</a></li>
