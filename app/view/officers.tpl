<div class="container">
  ...
  <div class="row">
   ...
   <!-- President and VP Row End -->

   <!-- Web Admin and Historian Start -->
      ...
      <div class="col s12 m6 l4">
        ...
        <div class="col s12 m6 l4">
          <div class="card medium hoverable sticky-action">
            ...
            <div class="card-reveal">
              ...
              <p>Suskriti Dixit is a junior at Virginia Tech who is majoring in Human Nutrition, Foods and Exercise and minoring in Psychology. At Virginia Tech, she is involved in the Nepalese Student Association as well as the Pre-Pharmacy Club. Last year, she served as an event coordinator for NSA and this year, she hopes to take on more challenges for the club as secretary. After obtaining her bachelor’s degree, she hopes to attend Pharmacy School and expand her knowledge about medicine. In her free time, she enjoys volunteering, gardening, cooking, outdoor activities, and watching Netflix.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col s12 m6 l4">
          ...
          <!-- Web Event Coordinator and Public Relations -->
          <div class="col s12 m6 l4">
            <div class="card medium hoverable sticky-action">
              <div class="card-image waves-effect waves-block waves-light">
