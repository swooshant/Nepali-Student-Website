...
<div class="parallax-container">
	...
	<a id="GobblerConnectBut" class="waves-effect waves-orange btn-flat"> Connect on GobblerConnect! </a>
...
<div class="slider">
	<ul class="slides center-align">
		<li>
			<img class="responsive-img" src="<?= BASE_URL ?>/public/img/nsarun.jpg"> <!-- random image -->
...
<h1>HAHAHA I'M IN THE SYSTEM - NISHANT but really put the blogging thing here</h1>
